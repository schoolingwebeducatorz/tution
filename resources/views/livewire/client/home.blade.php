            ...
            <div class="container">
                <div class="hero-content">
                    <div class="section-heading">
                        ...
                        <p class="section__desc text-white pb-4">Matheducatorz providing in house tutor for your child to support your child in that subject in which you want to improve grades. We support you in online classes and also backup recordings on LMS so student can revise his lesson when ever he want.
                        </p>
                    </div><!-- end section-heading -->
                    <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1">
                        <a href="{{ route('trail.book') }}" class="btn theme-btn mr-4 mb-4">Book Your Trail<i class="la la-arrow-right icon ml-1"></i></a> 
        ...
        <div class="hero-slider-item hero-bg-2">
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">Join Matheducatorz & Get <br> Your Free Computer Sessions</h2>
                        <p class="section__desc text-white pb-4">
                            Matheducatorz providing free sessions to students for make them more expert in online world.
                            Join us and get free training's of web development , mobile development , graphic designing and any other computer skills.
                        </p>
                    </div><!-- end section-heading -->
        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">We have expert teacher here to help you in your required subjects to support you in your issues with your any subject</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">We have LMS support for students and 24/7 trainer support so if you need help anytime you can get in touch with us and solve your problem</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Short Course Certifications</h3>
                    <p class="info__text">We also provide free certifications to our enrolled students so he/she can perform well in his practical life.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="section-heading text-center">
                ...
                <div class="row mt-1">
                    ...
                    <div wire:loading>
                        ...
                        <select name="" class="form-control" wire:change="subjectfind" wire:model="coutr" id="">
                            @foreach($countries as $country)
                            <option value="{{ $country->id }}"> <img src="{{ asset('storage/app/public/country') }}/{{ $country->photo }}" height="15px" /> {{ $country->location->country }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="cta-content-wrap text-center">
            <div class="section-heading">
                ...
                <h2 class="section__title fs-45 lh-55">Enhance Your Education Skills with <br> Best Online Courses</h2>
            </div><!-- end section-heading -->
            <div class="cat-btn-box mt-28px">
                <a href="{{ route('trail.book') }}" class="btn theme-btn">Book Your Free Trail <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
            ...
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Benefits of Learning With Matheducatorz</h2>
                        <span class="section-divider"></span>
...
<section class="client-logo-area section-padding position-relative overflow-hidden text-center">
    ...
    <div class="container">
        <div class="section-heading">
            ...
            <h2 class="section__title">Top companies choose <a href="for-business.html" class="text-color hover-underline">Matheducatorz for Business</a> to build
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Teach what you love. Matheducatorz gives you the tools to create a course.</p>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Matheducatorz for Business</h5>
                        <p class="card-text">Get unlimited access to 5,000+ of Matheducatorz's top courses for your team</p>
                        <div class="btn-box mt-20px">
                            <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="la la-briefcase mr-1"></i>Get Matheducatorz for business</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
