            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                    <div class="section-heading">
                        <h2 class="section__title text-white">Book Your Trail</h2>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="register-heading-content-wrap text-center">
                    <div class="section-heading">
                        <h2 class="section__title">Fill Up this Form to book your trail</h2>
                        ...
                        <form wire:submit="save" class="row">
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" wire:model="name" type="text" name="name" placeholder="e.g. Alex">
                            ...
                            <div class="input-box col-lg-6">
                            <label class="label-text">Select Country</label>
                                <div class="form-group">
                                    <div class="select-container w-auto">
                                        <select class="form-control form--control" wire:model="country">
                                            <option value="select-a-category" selected="">Your Country</option>
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" wire:model="email" placeholder="e.g. alexsmith@gmail.com">
                            ...
                            <div class="input-box col-lg-6">
                                <label class="label-text">What's App Number</label>
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control" wire:model="whatsapp" placeholder="What's App Number" type="text" name="text">
                             ...
                             <div class="input-box col-lg-6">
                                <label class="label-text">Select Grade/Year</label>
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control" wire:model="grade" placeholder="Grade/Year" type="text" name="text">
                                    <span class="la la-list input-icon"></span>
                                    @error('grade')
                                    <font color="red"><b>{{ $message }}</b></font>
                                    @enderror
                                </div>
                            ...
                            <div class="input-box col-lg-6">
                                <label class="label-text">Select Schedule</label>
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        <div class="select-container w-auto">
                                            <select class="form-control form--control" wire:model="slots">
                                                <option>Time Slot</option>
                                                @foreach(App\Models\timetable::all() as $timetable)
                                                <option value="{{ $timetable->id }}"> {{ date('h:i:s a', strtotime($timetable->start)) }}  -  {{ date('h:i:s a', strtotime($timetable->end)) }} </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        <div class="select-container w-auto">
                                            <input type="date" wire:model="rdate" class="form-control form--control">
                            ...
                            <div class="btn-box col-lg-12">
                                <button class="btn theme-btn" type="submit">Book Your Trail <i class="la la-arrow-right icon ml-1"></i></button>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
