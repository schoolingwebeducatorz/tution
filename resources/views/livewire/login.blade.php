            ...
            <div class="col-lg-7 mx-auto">
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <form wire:submit="login" class="pt-4">

                            <div class="input-box">
                                <label class="label-text">Email or Username</label>
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" wire:model="email" name="name" placeholder="Email or Username">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control form--control password-field" type="password" wire:model="password" name="password" placeholder="Password">
